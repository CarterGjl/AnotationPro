...
import aop.demo.jetpack.android.apt_anotation.Preferences;
...
public class PreferencesProcessor extends AbstractProcessor {
     ...
     * @return
     */
    private FieldSpec generateKeyField(TypeElement typeElement) {        return FieldSpec.builder(String.class, "KEY")
            .addModifiers(Modifier.PRIVATE, Modifier.STATIC, Modifier.FINAL)
